...
PLOCK_PLONE_4_3_URL = "%s/plock/pins/master/plone-5-0" % GITHUB_RAW_URL
PLOCK_PLONE_DEV_URL = "%s/plock/pins/master/dev" % GITHUB_RAW_URL
UNIFIEDINSTALLER_DIR = "Plone-5.0b2-UnifiedInstaller"
UNIFIEDINSTALLER_URL = "https://launchpad.net/plone/5.0/5.0b2/+download/"
UNIFIEDINSTALLER_URL += "Plone-5.0b2-UnifiedInstaller-r1.tgz"
